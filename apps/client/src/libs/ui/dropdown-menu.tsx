...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("mx-1.5 my-[5px] h-px bg-separator", className)}
      {...props}
    />
  )
}
